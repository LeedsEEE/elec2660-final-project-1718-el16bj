...
- (void)viewDidLoad {
    ...
    self.data = [[DataModelOne alloc] init]; //Getting data from my DataModel
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([[segue identifier] isEqualToString:@"ShowProductDetails"]) { //Identifying seque
        ...
        ViewControllerFive *destinationViewController = [segue destinationViewController]; //Choosing seque destination ie. new view controlller
